...
class Event:
    ...
    def displayEventCountByCameraID(self):
        ...
        plotlyFigEventCountByCameraID = px.bar(self.factEvent['camera_id'].value_counts(dropna=False), 
                                                orientation='v',
    ...
    def displayDetectionConfidenceByEventAndItemType(self):
        ...
        confidence = pd.crosstab(self.factEvent['event_type'], 
    ...
    def displayHourlyDetectionConfidence(self):
        ...
        dfHourlyConfidence = self.factEvent.pivot_table(values=['confidence'],
                                                   index=['datetime'],
                                                   columns=['event_type'],
    ...
    def displayHourlyEventCount(self, selectedDestinations, eventCountString):
        ...
        self.singleOrDoubleDestinationPlotting(selectedDestinations,
